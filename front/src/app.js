...
// Enable access to logging on the global scope
 ...
 */
async function processPageEntered(
  pageNameToClass,
  pageName,
  pageData,
  historyData
          ...
          <div class="ion-margin-start ion-margin-bottom">
            ${pageData.back == true
              ? html` <ion-button
                  ...
                  @click=${() => history.back()}
                >
                  <ion-icon slot="start" name="chevron-back"></ion-icon>${T(
                    "Back"
                  )}
                </ion-button>`
        ...
        <div class="w3-container w3-half-centered w3-padding-64">
          <div class="w3-card-4 w3-center">
            ...
            <div class="w3-container">
              ...
              ${pageData.details
                ? html` <div class="w3-medium">${pageData.details}</div> `
                : null}
            </div>
            ...
            ${pageData.back == true
              ...
              : html`
                  <div class="w3-medium">
                    ${T("Please click Accept to refresh the page.")}
                  </div>
                `}
