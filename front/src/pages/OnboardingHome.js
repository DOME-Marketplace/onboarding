...
MHR.register(
  ...
  class extends MHR.AbstractPage {
    ...
    <div class="w3-padding-32" style="background-color: #EDF2FA;">
      ...
      <!-- Form -->
      <div class="dome-content">
        <form name="theform" @submit=${(e) =>
          this.validateForm(e)} id="formElements" class="w3-margin-bottom">
    ...
    async fillTestData(ev) {
      ...
      document.forms["theform"].elements["LegalRepNationality"].value =
        "Spanish";
      document.forms["theform"].elements["LegalRepIDNumber"].value =
        "24676932R";
      ...
      document.forms["theform"].elements["LEARPostalAddress"].value =
        "C/ Academia 54, Madrid - 28654, Spain";
      document.forms["theform"].elements["LEAREmail"].value =
        "john.doe@airquality.com";
      document.forms["theform"].elements["LEARMobilePhone"].value =
        "+34876549022";
    }
    ...
    async validateForm(ev) {
      ...
      // Present the page with the documents for review and printing
...
MHR.register(
  ...
  class extends MHR.AbstractPage {
    ...
    async fillTestData(ev) {
      ...
      // document.forms['buyer_onboarding_form'].elements["LegalRepFirstName"].value = "Jesus"
      // document.forms['buyer_onboarding_form'].elements["LegalRepLastName"].value = "Ruiz"
      // document.forms['buyer_onboarding_form'].elements["LegalRepNationality"].value = "Spanish"
      // document.forms['buyer_onboarding_form'].elements["LegalRepIDNumber"].value = "24676932R"
      document.forms["buyer_onboarding_form"].elements["LegalRepCommonName"].value =
        "Jesus Ruiz";
      document.forms["buyer_onboarding_form"].elements["LegalRepEmail"].value =
        "jesus@alastria.io";

      document.forms["buyer_onboarding_form"].elements["CompanyName"].value =
        "Air Quality Cloud";
      document.forms["buyer_onboarding_form"].elements["CompanyStreetName"].value =
        "C/ Academia 54";
      document.forms["buyer_onboarding_form"].elements["CompanyCity"].value =
        "Madrid";
      document.forms["buyer_onboarding_form"].elements["CompanyPostal"].value =
        "28654";
      document.forms["buyer_onboarding_form"].elements["CompanyCountry"].value =
        "Spain";
      document.forms["buyer_onboarding_form"].elements[
        "CompanyOrganizationID"
      ].value = "VATES-B35664875";

      document.forms["buyer_onboarding_form"].elements["LEARFirstName"].value =
        "John";
      document.forms["buyer_onboarding_form"].elements["LEARLastName"].value = "Doe";
      document.forms["buyer_onboarding_form"].elements["LEARNationality"].value =
        "Spanish";
      document.forms["buyer_onboarding_form"].elements["LEARIDNumber"].value =
        "56332876F";
      document.forms["buyer_onboarding_form"].elements["LEARPostalAddress"].value =
        "C/ Academia 54, Madrid - 28654, Spain";
      document.forms["buyer_onboarding_form"].elements["LEAREmail"].value =
        "john.doe@airquality.com";
      document.forms["buyer_onboarding_form"].elements["LEARMobilePhone"].value =
        "+34876549022";
    }
