    ...
    var theHtml = html`
        ...
        <div class="w3-panel w3-card-2">
          ...
          <div style="padding:8px;margin-bottom: 16px;border: 1px solid">
            ...
            <p>
              Before designating the Legal Entity Appointed Representative, please, read carefully all the document.
              It gives a detailed overview of the implications of designating a LEAR
            ...
            <p>
              You may also wish to read the <a href="https://knowledgebase.dome-marketplace.eu/books/company-onboarding-process-guide-for-cloud-service-providers-csp/page/practical-considerations-for-entities-on-the-appointment-of-legal-entity-appointed-representative-form">Practical Considerations for Entities on the appointment of Legal Entity Appointed Representative Form</a> where you can find some useful additional information.
            </p>
          ...
          <p>
            The LEAR must have all the capacity and powers to legally represent and bind the Company, for a <u>minimum</u> amount/value of each transaction or legal act of 100,000.00 euro (one hundred thousand euro), in the following transactions/legal acts:
          </p>
