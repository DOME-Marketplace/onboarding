    ...
    async enter() {
      ...
      try {
        ...
        if (authData.token) {
          ...
          gotoPage("BuyerOnboardingForm", { authData });
          return;
        }
      } catch (error) {
...
MHR.register(
  ...
  class extends MHR.AbstractPage {
    ...
    async fillTestData(ev) {
      ev.preventDefault();
      document.forms["onboarding_form"].elements["LegalRepCommonName"].value = "Jesus Ruiz";
      document.forms["onboarding_form"].elements["LegalRepEmail"].value = "jesus@alastria.io";
      document.forms["onboarding_form"].elements["CompanyName"].value = "Air Quality Cloud";
      document.forms["onboarding_form"].elements["CompanyStreetName"].value = "C/ Academia 54";
      document.forms["onboarding_form"].elements["CompanyCity"].value = "Madrid";
      document.forms["onboarding_form"].elements["CompanyPostal"].value = "28654";
      document.forms["onboarding_form"].elements["CompanyCountry"].value = "Spain";
      document.forms["onboarding_form"].elements["CompanyOrganizationID"].value = "VATES-B35664875";
      document.forms["onboarding_form"].elements["LEARFirstName"].value = "John";
      document.forms["onboarding_form"].elements["LEARLastName"].value = "Doe";
      document.forms["onboarding_form"].elements["LEARNationality"].value = "Spanish";
      document.forms["onboarding_form"].elements["LEARIDNumber"].value = "56332876F";
      document.forms["onboarding_form"].elements["LEARPostalAddress"].value = "C/ Academia 54, Madrid - 28654, Spain";
      document.forms["onboarding_form"].elements["LEAREmail"].value = "john.doe@airquality.com";
      document.forms["onboarding_form"].elements["LEARMobilePhone"].value = "+34876549022";
    }
    async submitForm(ev) {
      ev.preventDefault();
      debugger;
